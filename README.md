...
[![Latest Release](https://img.shields.io/github/v/release/DasClown/CropProphEU)](https://github.com/DasClown/CropProphEU/releases/latest)
...
**Production costs** are **country- and crop-specific** (V5.3+). See `market_prices.py` → `COUNTRY_PRODUCTION_COSTS` (28 EU countries × 5 crops). Sources: FADN, KTBL, ARVALIS. Examples:

| Country | Wheat | Corn | Barley | Rapeseed | Sunflower |
|:--------|:-----:|:----:|:------:|:--------:|:---------:|
| 🇩🇪 DE | 650 | 700 | 600 | 780 | 650 |
| 🇫🇷 FR | 700 | 650 | 600 | 750 | 600 |
| 🇵🇱 PL | 550 | 600 | 500 | 650 | 550 |
| 🇷🇴 RO | 450 | 500 | 400 | 550 | 450 |
| 🇪🇸 ES | 600 | 650 | 550 | 700 | — |
